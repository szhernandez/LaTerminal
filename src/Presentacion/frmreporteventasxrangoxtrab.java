 ...
 * @author ZAIR
 */
public class frmreporteventasxrangoxtrab extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VENTAS POR RANGO POR TRABAJADOR");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbltotalimporte, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
         try {
           ...
           Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/smartpos_terminal", "root", "");
            JasperReport jr= (JasperReport)JRLoader.loadObject(frm_pruebas.class.getResource("/Reportes/Ventasxrangoxtrab.jasper"));
    ...
    private void txttrabajadorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txttrabajadorMouseClicked
        ...
        dialog.padre="reporteventasxrangoxtrabajador";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmreporteventasxrangoxtrab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmreporteventasxrangoxtrab().setVisible(true);
            }
        });
    }
