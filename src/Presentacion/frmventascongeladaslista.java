 ...
 * @author ZAIR
 */
public class frmventascongeladaslista extends javax.swing.JInternalFrame {

    /**
     * Creates new form frmlistadoclientes
     */
    public frmventascongeladaslista() {
        initComponents();
    ...
    public frmventascongeladaslista(Dialog dialogo) {
        initComponents();
    ...
    tablaventas.getColumnModel().getColumn(7).setPreferredWidth(100);
     //hora
    tablaventas.getColumnModel().getColumn(8).setPreferredWidth(100);
     ...
     void mostrar(String buscar){
        try {
            ...
            logventacongelada func = new logventacongelada();
            modelo = func.mostrartablaventacongelada(buscar);
    ...
    private void initComponents() {
        ...
        lbltotal.setBackground(new java.awt.Color(3, 79, 132));
        ...
        jLabel1.setText("PREVENTAS POR DIA");
...
JOptionPane.showMessageDialog(null, "ERROR ", "Error..!!", JOptionPane.ERROR_MESSAGE);
    ...
    private void tablaventasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaventasMouseClicked
       ...
       int columna = tablaventas.getSelectedColumn();
            try {
       frmpuntoventa_preventa.idventacongelada=tablaventas.getValueAt(fila, 0)+"";
       dialogo.dispose();
        } catch (Exception e) {
           // JOptionPane.showMessageDialog(null,"Error: " + e.toString());//Se comento para no mostrar error
        }
      }//Fin if
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmventascongeladaslista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmventascongeladaslista().setVisible(true);
            }
        });
    }
