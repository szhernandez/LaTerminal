 ...
 * @author ZAIR
 */
public class frmreportecomprasxdia extends javax.swing.JInternalFrame {

    /**
     * Creates new form frmlistadoclientes
     */
    public frmreportecomprasxdia() {
        initComponents();
    ...
    tablaventas.getColumnModel().getColumn(9).setMaxWidth(0);
     ...
     void mostrar(String buscar){
        try {
            ...
            modelo = func.mostrartablacompra(buscar);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("COMPRAS POR DIA");
...
JOptionPane.showMessageDialog(null, "ERROR ", "Error..!!", JOptionPane.ERROR_MESSAGE);
    ...
    private void tablaventasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaventasMouseClicked
        ...
        String num_compra=tablaventas.getValueAt(fila, 0).toString();//asignando valor a numero de venta
        ticket.reimprimiendo_nota_compra("Sin nombre", "esto es una", "Reimpresion",num_compra);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmreportecomprasxdia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmreportecomprasxdia().setVisible(true);
            }
        });
    }
