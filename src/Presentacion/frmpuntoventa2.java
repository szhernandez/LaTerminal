 ...
 * @author ZAIR
 */
public class frmpuntoventa2 extends javax.swing.JInternalFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtbuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE)
...
//en la parte de arriba indica el primer parametro la fila y el segundo la columna la cual estaras //manejando
    ...
    try {
       ...
       dialogvacio dialogo = new dialogvacio(null, true);
        frmcobro2 ventanacobro = new frmcobro2(dialogo,lbltotal.getText(),"puntodeventa2");//Se envia el importe a cobrar mediante el contructor
  ...
  //  logarticulo logart = new logarticulo();
    ...
    if (evt.getKeyCode() == evt.VK_F5){
        ...
        */
        dialogvacio dialogo = new dialogvacio(null, true);
        frmproductopuntoventa ventanaproducto = new frmproductopuntoventa(dialogo,txtbuscar.getText(),"puntoventa2");//Se envia el importe a cobrar mediante el contructor
 ...
 try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmpuntoventa2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmpuntoventa2().setVisible(true);
            }
        });
    }
