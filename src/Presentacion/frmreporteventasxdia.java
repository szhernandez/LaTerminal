 ...
 * @author ZAIR
 */
public class frmreporteventasxdia extends javax.swing.JInternalFrame {

    /**
     * Creates new form frmlistadoclientes
     */
    public frmreporteventasxdia() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VENTAS POR DIA ADMINISTRADOR");
...
JOptionPane.showMessageDialog(null, "ERROR ", "Error..!!", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmreporteventasxdia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmreporteventasxdia().setVisible(true);
            }
        });
    }
